...
public interface IRecompensaViewModel
{
    ...
    Task<ApiResponse<CanjeResponse>> CanjearAsync(string usuarioId, CanjeRequest request);
    Task<ApiResponse<RecompensaResponse>> CreateAsync(RecompensaRequest request);
    Task<ApiResponse<RecompensaResponse>> UpdateAsync(string id, RecompensaRequest request);
